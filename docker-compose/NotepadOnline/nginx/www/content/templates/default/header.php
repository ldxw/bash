...
<head>
    ...
    <meta name="author" content="bj.ldxw.vip" />
    <meta name="keywords" content="跨端传输,同屏传输,在线笔记,简单,简约,笔记,NotePad,NPO,NotePadOnLine" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title><?php ($esN)?(print $name."(只读)"):(print $name);?> - 笔记</title>
...
<body>
	...
	<!-- <div class="container"> -->
		...
		<span class="navbar-brand">&nbsp;&nbsp;<?php ($esN)?(print $name."(只读)"):(print $name);?> - 笔记</span>
...
<!-- 			<div class="broadcastTop alert alert-info mb-0" role="alert">
		  ...
		  <div class="btn-group">
			...
			<a href="#" class="btn btn-light" id="mobBtn" data-toggle="popover" data-placement="bottom" data-trigger="hover" title="移动端扫码以继续访问" data-html=true data-content='<img width=100% src="http://ldxw.top/tool/qr/?text=<?php echo $URL."/".$esL.$name;?>"/>'><i class="fas fa-mobile-alt"></i></a>
